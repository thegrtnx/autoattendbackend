...
export class AuthService {
  ...
  async verifyOtp(verifyOtpDto: VerifyOtpDto) {
    ...
    const isOtpExpired =
      user.otp && user.otpExpiredAt && user.otpExpiredAt < new Date();
    ...
    console.log(user.userId, user.email, this.configService)
  ...
  async forgotPassword(forgotPasswordDto: ForgotPasswordDto) {
    ...
    await this.prisma.user.update({
      ...
      data: {
        ...
        resetOtpExpiredAt: resetTokenExpiration,
      },
    });
  ...
  async resetPassword(resetPasswordDto: ResetPasswordDto) {
    ...
    const isResetOtpExpired =
      user.resetOtp && user.resetOtpExpiredAt && user.resetOtpExpiredAt < new Date();
